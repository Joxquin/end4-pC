...
WindowDialog {
    ...
    readonly property list<var> colorOptions: [
        { color: "#4285F4", id: "1", name: "Azul" },
        { color: "#0F9D58", id: "2", name: "Verde" },
        { color: "#9C27B0", id: "3", name: "Morado" },
    ...
    Flickable {
        ...
        ColumnLayout {
            ...
            StyledText {
                text: Translation.tr("Eventos de Google Calendar")
                font.weight: Font.DemiBold
                        ...
                        ColumnLayout {
                            ...
                            StyledText {
                                text: {
                                    ...
                                    return Translation.tr("Todo el día");
                                }
            ...
            Rectangle {
                ...
                StyledText {
                    ...
                    text: Translation.tr("No hay eventos programados para este día.")
            ...
            StyledText {
                text: Translation.tr("Agregar Nuevo Evento")
                font.weight: Font.DemiBold
                font.pixelSize: Appearance.font.pixelSize.normal
                color: Appearance.colors.colPrimary
            }
            ...
            RowLayout {
                Layout.fillWidth: true
                StyledText {
                    text: Translation.tr("Todo el día")
                    color: Appearance.colors.colOnLayer0
                    Layout.fillWidth: true
                }
                ConfigSwitch {
