...
Rectangle {
    ...
    readonly property var monthNames: [
        Translation.tr("Enero"), Translation.tr("Febrero"), Translation.tr("Marzo"),
        Translation.tr("Abril"), Translation.tr("Mayo"), Translation.tr("Junio"),
        Translation.tr("Julio"), Translation.tr("Agosto"), Translation.tr("Septiembre"),
        Translation.tr("Octubre"), Translation.tr("Noviembre"), Translation.tr("Diciembre")
    ]

    readonly property var weekdayShortNames: [
        Translation.tr("Lu"), Translation.tr("Ma"), Translation.tr("Mi"),
        Translation.tr("Ju"), Translation.tr("Vi"), Translation.tr("Sá"), Translation.tr("Do")
    ]
    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            StyledText {
                ...
                text: Translation.tr("Agregar tarea")
            }
        ...
        Flickable {
            ...
            ColumnLayout {
                ...
                TextField {
                    ...
                    placeholderText: Translation.tr("Título de la tarea")
                ...
                Rectangle {
                    ...
                    ColumnLayout {
                        ...
                        RowLayout {
                            ...
                            StyledText {
                                text: Translation.tr("Fecha de vencimiento")
                                font.weight: Font.DemiBold
                ...
                Rectangle {
                    ...
                    ColumnLayout {
                        ...
                        RowLayout {
                            ...
                            StyledText {
                                text: Translation.tr("Establecer hora")
                                font.weight: Font.DemiBold
                                font.pixelSize: Appearance.font.pixelSize.small
                                color: Appearance.colors.colOnLayer0
                            }
                ...
                Rectangle {
                    ...
                    ColumnLayout {
                        ...
                        RowLayout {
                            ...
                            StyledText {
                                text: Translation.tr("Repetir tarea")
                                font.weight: Font.DemiBold
                                font.pixelSize: Appearance.font.pixelSize.small
                                color: Appearance.colors.colOnLayer0
                            }
                        ...
                        ColumnLayout {
                            ...
                            RowLayout {
                                ...
                                StyledComboBox {
                                    Layout.fillWidth: true
                                    model: [
                                        Translation.tr("Día(s)"),
                                        Translation.tr("Semana(s)"),
                                        Translation.tr("Mes(es)"),
                                        Translation.tr("Año(s)")
                                    ]
                            ...
                            ColumnLayout {
                                ...
                                StyledText {
                                    text: Translation.tr("Días de la semana:")
                                    font.pixelSize: Appearance.font.pixelSize.smaller
                            ...
                            ColumnLayout {
                                ...
                                RowLayout {
                                    ...
                                    StyledText {
                                        text: Translation.tr("Día del mes:")
                                        font.pixelSize: Appearance.font.pixelSize.small
                                        color: Appearance.colors.colOnLayer1
                                    }
                                    StyledSpinBox {
                            ...
                            ColumnLayout {
                                ...
                                RowLayout {
                                    ...
                                    StyledText {
                                        text: Translation.tr("Repeticiones:")
                                        font.pixelSize: Appearance.font.pixelSize.small
                                        color: Appearance.colors.colOnLayer1
                                    }
                                    StyledSpinBox {
        ...
        RowLayout {
            ...
            DialogButton {
                buttonText: root.isAdding ? Translation.tr("Guardando...") : Translation.tr("Agregar tarea")
